...
(deftest x []
  (is (= (set (for [rel [:my/link :options]]
                {:link/rel rel
                 ...
                 :link/managed? false}))
         (set (link-controls-util/ui-contextual-links [] true true mock-links nil))))
  ...
  (is (= (apply set/union (for [rel [:my/link :options]]
                            #{{:link/rel rel
                              ...
                              {:link/rel rel
                               ...
                               :link/render-inline? true
                               :link/managed? true}}))
         (into #{} (link-controls-util/ui-contextual-links [0] false false mock-links nil))))
  ...
  (is (= (set [{:link/rel :my/link
                ...
                :link/render-inline? true
                :link/managed? false}])
         (set (link-controls-util/ui-contextual-links [0 :some/attr] false true mock-links [link/options-processor])))))
