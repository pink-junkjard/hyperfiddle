...
(def r2 {:db/id 17592186061847,
         ...
         [{:db/id 17592186061848,
           :link/class [:hf/remove :fiddle],}
          {:db/id 17592186061849,
           :link/class [:link :hf/remove],
          ...
          {:db/id 17592186061850,
           ...
           {:db/id 17592186045605,
            ...
            :fiddle/type :query},
           :link/class [:fiddle-options :hf/iframe]}
          {:db/id 17592186061851,
           :link/class [:hf/affix :fiddle],
           :link/fiddle
...
(deftest fiddle-validates
  ...
  (is (= (validate :hyperfiddle/ide r2 smart-lookup-ref-no-tempids)
         '(#_[[:fiddle/links 17592186061852 :link/class] #{:hf/affix :hf/new :hf/detach :hf/remove :hf/iframe :hf/rel :hf/self}]
...
(def links
  [{:link/class #{:hf/remove}}
   {:link/class #{:hf/affix}}
   {:link/class #{:hf/affix} :link/fiddle {:fiddle/ident :yo}}])
